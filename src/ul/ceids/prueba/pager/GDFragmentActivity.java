...
import android.widget.FrameLayout;
	 ...
	 */
	public class GDFragmentActivity extends FragmentActivity implements ActionBarActivity {
	    ...
	    public GDFragmentActivity(ActionBar.Type actionBarType) {
	        super();
	            ...
	            if (position == OnActionBarListener.HOME_ITEM) {
	                ...
	                switch (mActionBarType) {
	                    case Normal:
	                        ...
	                        if (klass != null && !klass.equals(GDFragmentActivity.this.getClass())) {
	                            if (Config.GD_INFO_LOGS_ENABLED) {
	                                Log.i(LOG_TAG, "Going back to the home activity");
	                            }
	                            Intent homeIntent = new Intent(GDFragmentActivity.this, klass);
